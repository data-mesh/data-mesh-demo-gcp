...
public class MenuItemProcessor {
    public static class ConvertCsvLinesToCleanMenuItemRecords extends DoFn<String, GenericRecord> {

        private String delimiter;
        private String schemaJson;

        public ConvertCsvLinesToCleanMenuItemRecords(String schemaJson, String delimiter) {
